  ...
  config = function()
    ...
    cmp.setup {
      ...
      mapping = cmp.mapping.preset.insert {
        ...
        ['<CR>'] = cmp.mapping.confirm { select = false }, --Select item
        ['<Esc>'] = cmp.mapping.abort(), --close autocomplete menu
        ...
        ['<C-h>'] = cmp.mapping(function()
          if luasnip.locally_jumpable(3) then luasnip.jump(-1) end
        end, { 'i', 's' }),
      ...
      window = {
        completion = {
          border = 'rounded', --Adds a border to the autocompletion window
