...
local function get_color_with_lualine(lualine_ok, lualine_theme, mode_name, section, attribute, fallback_hls, fallback_attribute, fallback_color)
  if lualine_ok and tables.tbl_get(lualine_theme, mode_name, section, attribute) then
...
---@param fallback_attribute 'fg'|'bg'
---@param fallback_color string?
local function get_color_with_lightline(lightline_theme, mode_name, section, attribute, fallback_hls, fallback_attribute, fallback_color)
  local sec1, sec2
  if section == 'a' then
    sec1 = 'left'
    sec2 = 1
...
local function setup_colors(colorname)
  ...
  local diagnostic_error = colors_hl.get_color_with_fallback({ 'DiagnosticSignError', 'ErrorMsg' }, 'fg', red)
  local diagnostic_warn = colors_hl.get_color_with_fallback({ 'DiagnosticSignWarn', 'WarningMsg' }, 'fg', yellow)
  local diagnostic_info = colors_hl.get_color_with_fallback({ 'DiagnosticSignInfo', 'None' }, 'fg', cyan)
  local diagnostic_hint = colors_hl.get_color_with_fallback({ 'DiagnosticSignHint', 'Comment' }, 'fg', grey)
  local git_add = colors_hl.get_color_with_fallback({ 'GitSignsAdd', 'GitGutterAdd', 'diffAdded', 'DiffAdd' }, 'fg', green)
  local git_change = colors_hl.get_color_with_fallback({ 'GitSignsChange', 'GitGutterChange', 'diffChanged', 'DiffChange' }, 'fg', yellow)
  local git_delete = colors_hl.get_color_with_fallback({ 'GitSignsDelete', 'GitGutterDelete', 'diffRemoved', 'DiffDelete' }, 'fg', red)
  ...
  text_bg = get_color_with_lualine(has_lualine, lualine_theme, 'normal', 'a', 'bg', { 'Normal' }, 'bg', black)
  text_fg = get_color_with_lualine(has_lualine, lualine_theme, 'normal', 'a', 'fg', { 'Normal' }, 'fg', white)
  ...
  normal_bg2 =
    get_color_with_lualine(has_lualine, lualine_theme, 'normal', 'b', 'bg', {}, 'bg', shade_rgb(get_terminal_color_with_fallback(0, magenta), shade_level1))
  normal_fg2 = get_color_with_lualine(has_lualine, lualine_theme, 'normal', 'b', 'fg', {}, 'fg', text_fg)
  normal_bg3 = get_color_with_lualine(has_lualine, lualine_theme, 'normal', 'c', 'bg', {}, 'bg')
  normal_fg3 = get_color_with_lualine(has_lualine, lualine_theme, 'normal', 'c', 'fg', {}, 'fg')
  ...
  insert_bg = get_color_with_lualine(has_lualine, lualine_theme, 'insert', 'a', 'bg', { 'String', 'MoreMsg' }, 'fg', get_terminal_color_with_fallback(2, green))
  insert_fg = get_color_with_lualine(has_lualine, lualine_theme, 'insert', 'a', 'fg', {}, 'fg', text_bg)
  ...
  visual_fg = get_color_with_lualine(has_lualine, lualine_theme, 'visual', 'a', 'fg', {}, 'fg', text_bg)
  replace_bg = get_color_with_lualine(has_lualine, lualine_theme, 'replace', 'a', 'bg', { 'Number', 'Type' }, 'fg', get_terminal_color_with_fallback(4, blue))
  replace_fg = get_color_with_lualine(has_lualine, lualine_theme, 'replace', 'a', 'fg', {}, 'fg', text_bg)
  command_bg = get_color_with_lualine(has_lualine, lualine_theme, 'command', 'a', 'bg', { 'Identifier' }, 'fg', get_terminal_color_with_fallback(1, red))
  command_fg = get_color_with_lualine(has_lualine, lualine_theme, 'command', 'a', 'fg', {}, 'fg', text_bg)
